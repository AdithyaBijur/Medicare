...
router.post('/', (req, res) => {
    ...
    if (req.body.email == undefined || req.body.password == undefined || req.body.userName == undefined || req.body.LcNo == undefined || req.body.name == undefined || req.body.phone == undefined) {
        console.log("send all details");
        res.status(403).json({ "msg": "all data not send" });
    }
    else {
        if (req.body.email == "" || req.body.password == "" || req.body.userName == "" || req.body.LcNo == "" || req.body.name == "" || req.body.phone == "") {
